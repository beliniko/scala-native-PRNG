...
object Main {
  ...
  final case class Configuration(
    ...
    sequenceSize: Int,
    @arg(short = 's', doc = "The start of the range of random numbers to generate")
    start: Int = 0,
    @arg(short = 'e', doc = "The end of the range of random numbers to generate")
    end: Int = 100
  ) {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val autocorrelation = unpredictableTest.autocorrelation(randomSeq, 1)
